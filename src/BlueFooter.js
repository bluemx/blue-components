class BlueFooter extends HTMLElement {
    ...
    render() {
        ...
        div.innerHTML = `
            <div style="text-align: right; padding: 4px 10px; ${hidePowered ? ' display:none !important;' : ''}" class="poweredby-blue">
                <div style="width: ${largePowered ? '220px' : '166px'}; margin-left: auto;">
